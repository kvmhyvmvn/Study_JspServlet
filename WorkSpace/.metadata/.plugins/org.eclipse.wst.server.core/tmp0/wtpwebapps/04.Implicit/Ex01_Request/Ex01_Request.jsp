...
<body>
	<h1> 요청해보기 </h1>
	<!-- 
		특정한 Servlet 파일(Mapping => "/요청주소")에 어떠한 정보를 주고 다음 작업을 요청한다. (Client)
		ex) 네이버에 아이디 비밀번호를 입력하고 로그인 버튼을 누른다. => 로그인 후 작업을 요청한다.
	 ...
	 -->
	 <!--  GET 방식으로 Servlet 요청해보기, POST 방식으로 Servlet에 요청해보기
