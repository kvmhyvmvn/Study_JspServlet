...
<body>
	...
	<p> ApplicationContext (어플리케이션이 완전히 종료되지 않는한 계속해서 유지됨 -> 버전 정보, 특정한 업데이트를 위한 값 외에는 저장 x) </p>
	<%
		pageContext.setAttribute("pageCtx", "KHM_PAGE_CTX"); // 페이지 내에서만 사용하는 객체
		request.setAttribute("req", "KHM_REQ");
		...
		session.setAttribute("session", "KHM_SESSION");
		application.setAttribute("app", "KHM_APPV1.1");
	%>
