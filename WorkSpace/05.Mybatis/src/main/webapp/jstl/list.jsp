...
<body>
	...
	<p>el : ${key2 }</p>
	<p>el : ${key3 }</p>
	<!--  jstlController에서 변수 3개를 더 request 객체를 통해서 보내보고 el로 표현해보기 -->
	<p>el : ${key4 }</p>
	<p>el : ${key5 }</p>
	<p>el : ${key6 }</p>
	<%-- <%if(num==0) {%>
	...
	<!-- 페이지 전환을 Controller를 하고싶음
		listdetail.js 요청을 하면 해당하는 맵핑을 판독하여 jstl폴더하위에 listdetail.jsp파일로 응답하고싶다.
		
		url이 바뀜 => a 태그, form 태그
	 -->
	 
	 <a href="listdetail.js">JstlController에 .js로 맵핑요청</a>
